...
import type { ObligationRow } from "../../../dblayer/seuTypes.js";
...
export async function createObligation(input: {
  ...
  await eventBus.publish({
    ...
    payload: { deliverableId: input.deliverableId, category: input.category, severity: obligation.severity },
  });
...
export async function transitionObligation(input: { obligationId: string; targetState: string; actorRole: string }): Promise<TransitionObligationResult> {
