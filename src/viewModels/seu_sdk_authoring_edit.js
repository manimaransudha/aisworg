...
export const seu_sdk_authoring_editVM = createViewModel({
  ...
  optional: ["flash", "errors", "referentialOptions", "packDependencyOptions", "templateOptions", "ontologyOptions", "contributionHelp", "verifiableFieldHelp", "possibleNextStates"],
});
