...
|---|:---:|---|
| **CKM-001** | `Unbuilt / Deferred` | Verified against No direct matches in `src/` (Unbuilt/Deferred). |
| **CKM-002** | `Unbuilt / Deferred` | Verified against No direct matches in `src/` (Unbuilt/Deferred). |
| **CKM-003** | `Unbuilt / Deferred` | Verified against No direct matches in `src/` (Unbuilt/Deferred). |
| **CKM-004** | `Unbuilt / Deferred` | Verified against No direct matches in `src/` (Unbuilt/Deferred). |
| **CKM-005** | `Unbuilt / Deferred` | Verified against No direct matches in `src/` (Unbuilt/Deferred). |
| **CKM-006 — superseded (CR-060, 2026-08-23; revised same day)** | `Fully Met` | Verified against [`app.js`](file://src/app.js), [`requireTenant.ts`](file://src/middleware/requireTenant.ts), [`requireTenantScope.ts`](file://src/middleware/requireTenantScope.ts). |
| **CKM-007 — superseded (§7)** | `Fully Met` | Verified against [`evidenceDB.ts`](file://src/dblayer/evidenceDB.ts), [`ebmsDB.ts`](file://src/dblayer/ebmsDB.ts), [`seuTypes.ts`](file://src/dblayer/seuTypes.ts). |
