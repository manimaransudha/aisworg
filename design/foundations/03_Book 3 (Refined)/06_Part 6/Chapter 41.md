...
A Version is an immutable identifiable snapshot of an engineering artefact at a specific point in time. Versions preserve engineering meaning. Versions are what the Runtime Kernel consumes.
