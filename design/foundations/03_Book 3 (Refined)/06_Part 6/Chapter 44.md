...
- the active **Engineering Behavior Model**
...
**Decision:** The platform shall create logical Engineering Checkpoints representing consistent snapshots of engineering execution. Checkpoints shall reference the Engineering Behavior Model, active artefact versions and the corresponding position in the engineering event stream. Recovery shall restore from an Engineering Checkpoint and, where necessary, replay subsequent Events to reconstruct the exact engineering state.
...
Recovery shall preserve Transition Definitions, Events and Engineering Behavior Models.
...
- active Engineering Behavior Model
- pending Commands
- active Work Items
- active Obligations
...
- version integrity
- Engineering Behavior Model integrity
