...
## 19.4 ✅ Contributions — structured & schema-defined; verifiable types added; Quality Gate contribution structure built (§9; CR-016; CR-058; CR-059; CR-060)
...
- **Materialisation caveat:** `seedContributions` materialises Capabilities/Services/Authority Rules/Policies/Quality Gates/Review Gates/**Checklists** (Review Gates added by CR-059, Checklists by CR-060, see below) into their tables. Obligation Definitions and the §20 fields still live in `packs.contributions` (JSONB) **only** — declaration; nothing consumes them yet (§19.14 execution).
